          ...
          <div className="col-lg-6 col-md-12 col-sm-12">
            <div className="skills-content s-about-content">
              <div className="skills-title pb-20">
                ...
                <h2>Chúng tôi cung cấp đa dạng lựa chọn khách sạn</h2>
              </div>
              <p>Chúng tôi tự hào mang đến cho quý khách những trải nghiệm lưu trú tuyệt vời với dịch vụ chất lượng cao và không gian sang trọng.</p>
              <div className="skills-content s-about-content mt-20">
                <div className="skills">
                  <div className="skill mb-30">
                    <div className="skill-name">Chất lượng dịch vụ</div>
                    <div className="skill-bar">
                      <div className="skill-per" id="80" />
                    </div>
                  </div>
                  <div className="skill mb-30">
                    <div className="skill-name">Dịch vụ bảo trì</div>
                    <div className="skill-bar">
                      <div className="skill-per" id="90" />
                    </div>
                  </div>
                  <div className="skill mb-30">
                    <div className="skill-name">Quản lý sản phẩm</div>
                    <div className="skill-bar">
